            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-4">
                        <div class="card">
                            <a class="img-card" href="emploisDuTemps.php">
                            <img src="images/emploi1.jpg" />
                          </a>
                            <div class="card-content">
                                <h4 class="card-title">
                                    <a href="emploisDuTemps.php"> Voir les emplois du temps
                                  </a>
                                </h4>
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div class="card">
                            <a class="img-card" href="listeEtudiants.php">
                            <img src="images/listeEtu.jpg" />
                          </a>
                            <div class="card-content">
                                <h4 class="card-title">
                                    <a href="listeEtudiants.php"> Liste des etudiants 
                                  </a>
                                </h4>
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div class="card">
                            <a class="img-card" href="coursEtudiants.php">
                            <img src="images/cours.jpg" />
                          </a>
                            <div class="card-content">
                                <h4 class="card-title">
                                    <a href="coursEtudiants.php">Consulter Votre cours 
                                  </a>
                                </h4>
