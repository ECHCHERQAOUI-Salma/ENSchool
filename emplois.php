...
$req = "select * from emploisdutemps";
$tab =  "<table class='table table-bordered'>";
$tab .= "<tr><th>Titre d'Emplois</th><th>Actions</th></tr>";
foreach($conn->query($req) as $ligne){ 
    $tab .= "<tr>";
    $tab .= "<td>".$ligne[1]."</td>";
    $tab .= "<td><a class='buton' href='display_pdf.php?idEmplois=".$ligne[0]."' target='_blank'>Ouvrir le PDF</a>";
    $tab .= "  <a class='buton' href='server/emplois.php?action=sup&idEmplois=".$ligne[0]."'>Supprimer</a></td>";
    $tab .= "</tr>";
}
$tab .= "</table>";
?>
...
<div class="container">
  ...
  <div class="collapse navbar-collapse" id="navbarsFurni">
    ...
    <div class="container emploi">
        <div class="row">
            <div class="col-6">
                <button class="btn" type="button" id="new">+ Emplois</button>
            </div>
        </div>
        <div class="row">
            <?php
  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="upload.php" method="post" enctype="multipart/form-data">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nouvelle emplois</h5>
